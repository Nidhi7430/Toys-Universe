    ...
    <PageLayout>
      ...
      <MDBContainer className="text-center py-5 w-75">
        <MDBTypography className=" mb-4">
          ...
          manufacturer. Our main focus is to engage kids in learning something
          new with our products. Educational toys can help kids boost their IQ,
          Enhances the development of their senses & Improved Concentration.
          Kids can Learn while playing. We put our efforts into making
          educational toys which can help kids learn while they play.
        </MDBTypography>
